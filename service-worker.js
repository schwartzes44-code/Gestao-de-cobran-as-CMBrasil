const CACHE='gestao-cobrancas-v1-0-alpha4-1-login-fix';
const CORE=['./','./index.html','./styles-alpha4.css?v=1.0.0a41','./cloud-alpha3.js?v=1.0.0a41','./app-alpha4.js?v=1.0.0a41','./manifest.webmanifest','./icon.svg'];

const CACHE='gestao-cobrancas-v1-0-alpha2-central';
const CORE=['./','./index.html','./styles.css?v=1.0.0a2','./cloud.js?v=1.0.0a2','./app.js?v=1.0.0a2','./manifest.webmanifest','./icon.svg'];
